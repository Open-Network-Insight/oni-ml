...
import org.spot.SpotLDACWrapper.{SpotLDACInput, SpotLDACOutput}
import org.spot.SuspiciousConnectsArgumentParser.SuspiciousConnectsConfig
import org.spot.dns.DNSSchema._
import org.spot.dns.DNSWordCreation
import org.spot.utilities.{CountryCodes, DomainProcessor, Quantiles, TopDomains}
import org.spot.utilities.DomainProcessor.DomainInfo
...
class DNSSuspiciousConnectsModel(inTopicCount: Int,
  ...
  /**
    ...
    * @return Dataframe with a column named [[org.spot.dns.DNSSchema.Score]] that contains the
